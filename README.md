# Development of web-applications - Animal Adoption website

## Description

This project is an animal adoption website, with registration and login services implemented. Developed using Symphony, pure Javascript and Bootstrap. 
...
+ Run `git clone https://github.com/Galimbor/DAW_EER.git`.
+ Open IntelliJ IDEA.
